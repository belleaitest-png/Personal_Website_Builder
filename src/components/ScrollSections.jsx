...
const PANELS = [
  // ── Live apps ──
  {
    ...
    body: 'Your WHOOP tracks recovery, HRV, strain, and sleep. Apex Health OS connects those signals to what you eat. It logs nutrition in natural language, spots micronutrient gaps, correlates patterns across your health data, and builds a grocery list your biology actually asked for. I had the idea because I owned the problem, and the agent handled the parts I could not.',
  ...
  },
  {
    ...
    body: "Trimester-aware health tracking that adapts as you do. Bloom surfaces the right supplements, flags nutrient gaps, and handles the product research so you can stop Googling at 2am and focus on growing a human. Built end to end in Lovable, no technical co-founder involved.",
    cta: 'Try Bloom \u2192',
  ...
  },
  {
    ...
    body: "Fertility rates are falling faster than most models predicted. This tool maps the demographic data country by country, projects population trajectories, and makes the scale of the decline impossible to ignore. It started as a chart I wanted for a paper and turned into the thing that made the argument.",
  ...
  // ── Coming soon ──
  {
    ...
    body: "Advisors, investors, co-founders, mentors. Every meaningful relationship deserves follow-through. An agent reads my conversation history, surfaces who is going cold, and drafts the follow-up. Salesforce for one person, minus the seat licence.",
    coming: true,
    tool: 'Claude Code',
  },
  {
